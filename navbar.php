    ...
    <nav class="bg-gray-800">
        <div class="container mx-auto flex flex-col sm:flex-row items-center justify-between py-4">
            ...
            <div class="flex space-x-4 items-center">
                ...
                <?php if ($isLoggedIn) : ?>
                    <a href="./create_post.php" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Create Post</a>
                    <a href="./SeeMyPost.php" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">See My Post</a>
                <?php endif; ?>
            </div>
            ...
            <div class="flex items-center mt-4 sm:mt-0">
                <?php if ($isLoggedIn) : ?>
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="text-gray-300 text-sm font-medium"><?php echo htmlspecialchars($username); ?></span>
                    </div>
                    <a href="./logout.php" class="text-gray-300 hover:text-white px-3 py-2 text-sm font-medium ml-4">Logout</a>
                <?php else : ?>
